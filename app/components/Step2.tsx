const Step2 = () => {
  return (
    <div className="w-[600px] my-4">
      ...
      <div className="flex  flex-wrap py-4 my-4">
        <div className="p-4 w-full sm:w-[48%] flex gap-4  rounded-[0.625rem] my-3 " style={{border: '1px solid #D1D5DB'}} >
          ...
          <p className="text-[#111827]">Beginner</p>
        </div>
        <div  className="p-4 w-full sm:w-[48%] flex gap-4  rounded-[0.625rem] my-3 ml-2" style={{border: '1px solid #D1D5DB'}}>
          <div className="bg-orange-400 w-7 h-7 rounded-full flex justify-center items-center">
            <svg
              width="20"
              height="20"
          ...
          <p className="text-[#111827]">Intermediate</p>
        </div>
        <div  className="p-4 w-full sm:w-[48%] flex gap-4  rounded-[0.625rem] my-3 " style={{border: '1px solid #D1D5DB'}}>
          <div className="bg-orange-400 w-7 h-7 rounded-full flex justify-center items-center">
            <svg
          ...
          <p className="text-[#111827]">Advanced</p>
        </div>
        <div  className="p-4 w-full sm:w-[48%] flex gap-4  rounded-[0.625rem] my-3 ml-2 " style={{border: '1px solid #D1D5DB'}}>
          <div className="bg-orange-400 w-7 h-7 rounded-full flex justify-center items-center">
            <svg
          ...
          <p className="text-[#111827]">Expert</p>
        </div>
      </div>
    </div>
  );
