...
const Step4 = ({ previousSteps, userDetails, submit }: Step4Props) => {
  ...
  return (
    <div className="my-4 p-2 mx-auto">
      ...
      <div className="flex flex-wrap justify-center p-2 gap-4 mb-4">
        <div className="flex w-full md:w-[32%] h-[4.3rem] p-4 flex-col items-start space-y-0.5 shrink-0 rounded-lg bg-gray-200 bg-opacity-50">
          <p className="text-[#4B5563] text-[0.75rem]">Full Name</p>
          <p className="text-[#111827] text-[0.75rem]">
            {userDetails.fullName}
          </p>
        </div>
        <div className="flex w-full md:w-[32%]  p-4 flex-col items-start space-y-0.5 shrink-0 rounded-lg bg-gray-200 bg-opacity-50">
